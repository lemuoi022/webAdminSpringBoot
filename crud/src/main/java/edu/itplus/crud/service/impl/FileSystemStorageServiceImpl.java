...
import edu.itplus.crud.exception.StorageException;
import edu.itplus.crud.exception.StorageFileNotFoundException;
    ...
    public void store(MultipartFile file, String storeFilename){
        try {
            ...
            if (!destinationFile.getParent().equals(this.rootLocation.toAbsolutePath())){
                throw new StorageException("Cannot store this file outside current directory");
            }
